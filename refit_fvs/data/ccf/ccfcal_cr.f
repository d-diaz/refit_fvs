      SUBROUTINE CCFCAL(IMODTY,ISPC,D,H,JCR,P,LTHIN,CCFT,CRWDTH,MODE)
      IMPLICIT NONE
C----------
C CR $Id$
C----------
...
C----------
      ...
      INTEGER MAP1(38),MAP2(38),MAP3(38),MAP4(38)
      INTEGER MAP5(38),MODE,ISPC,IMAP,JCR,IMODTY
      REAL CRWDTH,CCFT,P,H,D
      REAL RDANUW
      INTEGER IDANUW
      LOGICAL LDANUW
C
Cf2py integer,intent(in) :: IMODTY
Cf2py integer,intent(in) :: ISP
Cf2py real,intent(in) :: D
Cf2py real,intent(hide) :: H
Cf2py integer,intent(hide) :: JCR
Cf2py real,intent(in) :: P
Cf2py logical,intent(hide) :: LTHIN
Cf2py real,intent(out) :: CCFT
Cf2py real,intent(hide) :: CRWDTH
Cf2py integer,intent(hide) :: MODE
C
      DATA MAP1/
     &  7,  7,  2,  7,  3,  1,  1,  1,  1,  1,
     &  1,  1,  8,  1,  1,  1,  1,  6,  6,  5,
